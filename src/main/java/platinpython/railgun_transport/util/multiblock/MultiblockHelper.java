package platinpython.railgun_transport.util.multiblock;
...
import platinpython.railgun_transport.block.entity.RailgunData;
import platinpython.railgun_transport.block.entity.TargetData;
...
public class MultiblockHelper {
    private static final ImmutableList<Block> BASE_BLOCKS = ImmutableList.of(
        Blocks.SMOOTH_STONE, Blocks.SMOOTH_STONE, Blocks.IRON_BLOCK, Blocks.SMOOTH_STONE, Blocks.REDSTONE_BLOCK,
        Blocks.NETHERITE_BLOCK, Blocks.SMOOTH_STONE, Blocks.SMOOTH_STONE, Blocks.IRON_BLOCK
    );

    private static final ImmutableList<Block> RAILGUN_BLOCKS = ImmutableList.of(
        Blocks.POLISHED_BLACKSTONE, Blocks.DIAMOND_BLOCK, Blocks.POLISHED_BLACKSTONE_WALL,
        Blocks.POLISHED_BLACKSTONE_STAIRS, Blocks.COPPER_BLOCK, Blocks.DISPENSER, Blocks.POLISHED_BLACKSTONE,
        Blocks.DIAMOND_BLOCK, Blocks.POLISHED_BLACKSTONE_WALL
    );

    private static final ImmutableList<Block> TARGET_BLOCKS = ImmutableList.of(
        Blocks.POLISHED_BLACKSTONE, Blocks.POLISHED_BLACKSTONE, Blocks.POLISHED_BLACKSTONE_WALL, Blocks.DIAMOND_BLOCK,
        Blocks.COPPER_BLOCK, Blocks.OBSERVER, Blocks.POLISHED_BLACKSTONE, Blocks.POLISHED_BLACKSTONE,
    ...
    private static MultiblockType getMultiblockType(TerminalBlockEntity blockEntity) {
        ...
        BlockPos frontLeftCorner =
            blockEntity.getBlockPos().relative(direction).relative(Rotation.COUNTERCLOCKWISE_90.rotate(direction));
        BlockPos backRightCorner =
            blockEntity.getBlockPos().relative(direction, 3).relative(Rotation.CLOCKWISE_90.rotate(direction));
        for (int i = 0; i < 9; i++) {
        ...
        MultiblockType type;
        BlockState determiningState =
            blockEntity.getLevel().getBlockState(blockEntity.getBlockPos().above().relative(direction));
    ...
    private static void assembleRailgun(TerminalBlockEntity blockEntity) {
        ...
        blockEntity.getLevel()
            .setBlock(
                ...
                blockEntity.getBlockState().setValue(TerminalBlock.MULTIBLOCK_TYPE, MultiblockType.RAILGUN),
                Block.UPDATE_ALL
            );
    ...
    public static void disassemble(TerminalBlockEntity blockEntity) {
        ...
        for (BlockPos pos : BlockPos.betweenClosed(frontLeftCorner, backRightCorner.above(2))) {
            ...
            blockEntity.getLevel()
                .getBlockEntity(pos, BlockEntityRegistry.MULTIBLOCK.get())
                .ifPresent(
                    multiblockBlockEntity -> blockEntity.getLevel()
                        .setBlock(pos, multiblockBlockEntity.savedBlockState(), Block.UPDATE_ALL)
                );
        }
