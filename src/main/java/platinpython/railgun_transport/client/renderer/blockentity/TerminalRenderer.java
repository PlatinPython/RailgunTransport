package platinpython.railgun_transport.client.renderer.blockentity;
...
import platinpython.railgun_transport.util.ModelLocations;
...
public class TerminalRenderer implements BlockEntityRenderer<TerminalBlockEntity> {
    ...
    public void render(
        ...
        if (multiblockType != MultiblockType.NONE) {
            ...
            this.modelRenderer.renderModel(
                poseStack.last(), bufferSource.getBuffer(RenderType.solid()), null,
                Minecraft.getInstance().getModelManager().getModel(ModelLocations.BASE), 1F, 1F, 1F,
                LevelRenderer.getLightColor(
                    Minecraft.getInstance().level, blockEntity.getBlockState(), blockEntity.getBlockPos()
    ...
    private void renderRailgun(
        ...
        this.modelRenderer.renderModel(
            poseStack.last(), bufferSource.getBuffer(RenderType.solid()), null,
            Minecraft.getInstance().getModelManager().getModel(ModelLocations.Railgun.MOUNT), 1F, 1F, 1F,
            LevelRenderer.getLightColor(
                Minecraft.getInstance().level, blockEntity.getBlockState(), blockEntity.getBlockPos().above()
            ), OverlayTexture.NO_OVERLAY, ModelData.EMPTY, RenderType.solid()
        );
        ...
        this.modelRenderer.renderModel(
            poseStack.last(), bufferSource.getBuffer(RenderType.solid()), null,
            Minecraft.getInstance().getModelManager().getModel(ModelLocations.Railgun.BODY), 1F, 1F, 1F,
            LevelRenderer.getLightColor(
                Minecraft.getInstance().level, blockEntity.getBlockState(), blockEntity.getBlockPos().above()
            ), OverlayTexture.NO_OVERLAY, ModelData.EMPTY, RenderType.solid()
        );
        ...
        this.modelRenderer.renderModel(
            poseStack.last(), bufferSource.getBuffer(RenderType.solid()), null,
            Minecraft.getInstance().getModelManager().getModel(ModelLocations.Railgun.HOLD), 1F, 1F, 1F,
            LevelRenderer.getLightColor(
                Minecraft.getInstance().level, blockEntity.getBlockState(), blockEntity.getBlockPos().above()
            ), OverlayTexture.NO_OVERLAY, ModelData.EMPTY, RenderType.solid()
        );
    ...
    private void renderTarget(
        ...
        this.modelRenderer.renderModel(
            poseStack.last(), bufferSource.getBuffer(RenderType.solid()), null,
            Minecraft.getInstance().getModelManager().getModel(ModelLocations.Target.MOUNT), 1F, 1F, 1F,
            LevelRenderer
                .getLightColor(Minecraft.getInstance().level, blockEntity.getBlockState(), blockEntity.getBlockPos()),
            OverlayTexture.NO_OVERLAY, ModelData.EMPTY, RenderType.solid()
        );
        poseStack.pushPose();
        ...
        this.modelRenderer.renderModel(
            poseStack.last(), bufferSource.getBuffer(RenderType.solid()), null,
            Minecraft.getInstance().getModelManager().getModel(ModelLocations.Target.SHAFT_FRONT), 1F, 1F, 1F,
            LevelRenderer
                .getLightColor(Minecraft.getInstance().level, blockEntity.getBlockState(), blockEntity.getBlockPos()),
            OverlayTexture.NO_OVERLAY, ModelData.EMPTY, RenderType.solid()
        );
        ...
        this.modelRenderer.renderModel(
            poseStack.last(), bufferSource.getBuffer(RenderType.solid()), null,
            Minecraft.getInstance().getModelManager().getModel(ModelLocations.Target.SHAFT_MIDDLE), 1F, 1F, 1F,
            LevelRenderer
                .getLightColor(Minecraft.getInstance().level, blockEntity.getBlockState(), blockEntity.getBlockPos()),
            OverlayTexture.NO_OVERLAY, ModelData.EMPTY, RenderType.solid()
        );
        ...
        this.modelRenderer.renderModel(
            poseStack.last(), bufferSource.getBuffer(RenderType.solid()), null,
            Minecraft.getInstance().getModelManager().getModel(ModelLocations.Target.SHAFT_BACK), 1F, 1F, 1F,
            LevelRenderer
                .getLightColor(Minecraft.getInstance().level, blockEntity.getBlockState(), blockEntity.getBlockPos()),
            OverlayTexture.NO_OVERLAY, ModelData.EMPTY, RenderType.solid()
        );
        ...
        this.modelRenderer.renderModel(
            poseStack.last(), bufferSource.getBuffer(RenderType.solid()), null,
            Minecraft.getInstance().getModelManager().getModel(ModelLocations.Target.CLAW_UP), 1F, 1F, 1F,
            LevelRenderer
                .getLightColor(Minecraft.getInstance().level, blockEntity.getBlockState(), blockEntity.getBlockPos()),
            OverlayTexture.NO_OVERLAY, ModelData.EMPTY, RenderType.solid()
        );
        this.modelRenderer.renderModel(
            poseStack.last(), bufferSource.getBuffer(RenderType.solid()), null,
            Minecraft.getInstance().getModelManager().getModel(ModelLocations.Target.CLAW_DOWN), 1F, 1F, 1F,
            LevelRenderer
                .getLightColor(Minecraft.getInstance().level, blockEntity.getBlockState(), blockEntity.getBlockPos()),
            OverlayTexture.NO_OVERLAY, ModelData.EMPTY, RenderType.solid()
        );
        this.modelRenderer.renderModel(
            poseStack.last(), bufferSource.getBuffer(RenderType.solid()), null,
            Minecraft.getInstance().getModelManager().getModel(ModelLocations.Target.CLAW_LEFT), 1F, 1F, 1F,
            LevelRenderer
                .getLightColor(Minecraft.getInstance().level, blockEntity.getBlockState(), blockEntity.getBlockPos()),
            OverlayTexture.NO_OVERLAY, ModelData.EMPTY, RenderType.solid()
        );
        this.modelRenderer.renderModel(
            poseStack.last(), bufferSource.getBuffer(RenderType.solid()), null,
            Minecraft.getInstance().getModelManager().getModel(ModelLocations.Target.CLAW_RIGHT), 1F, 1F, 1F,
            LevelRenderer
                .getLightColor(Minecraft.getInstance().level, blockEntity.getBlockState(), blockEntity.getBlockPos()),
            OverlayTexture.NO_OVERLAY, ModelData.EMPTY, RenderType.solid()
        );
    ...
    @Override
    public AABB getRenderBoundingBox(TerminalBlockEntity blockEntity) {
        Direction direction = blockEntity.getBlockState().getValue(TerminalBlock.HORIZONTAL_FACING).getOpposite();
        return AABB.encapsulatingFullBlocks(
            blockEntity.getBlockPos().relative(direction).relative(direction.getCounterClockWise()),
            blockEntity.getBlockPos().above(2).relative(direction, 3).relative(direction.getClockWise())
        );
    }
}
